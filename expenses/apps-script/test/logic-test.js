...
const HEADER_ROW = FAKE.HEADER_ROW;
const FIRST_ENTRY_ROW = FAKE.FIRST_ENTRY_ROW;
const FORMULA_LAST_ROW = FAKE.FORMULA_LAST_ROW;
const CATEGORIES = FAKE.CATEGORIES;
const makeTab = FAKE.makeTab;
const makeNotesTab = FAKE.makeNotesTab;
const makeEmptyTab = FAKE.makeEmptyTab;
const makeSpreadsheet = FAKE.makeSpreadsheet;
