...
| Location | Garage / shed / workshop | Cold ambient. Enclosure moves from nice-to-have to necessary. Noise and fumes are not constraints. |
...
- **Open-frame printers.** A cold garage plus an open frame means warping and
  poor layer adhesion on anything but PLA.
